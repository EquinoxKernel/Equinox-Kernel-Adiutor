...
public class Battery {
    ...
    private static final String ENABLE_CHARGING = POWER_SUPPLY + "/battery/input_suspend";
    ...
    public void enableCharging(boolean enable, Context context) {
        run(Control.write(enable ? "0" : "1", ENABLE_CHARGING), ENABLE_CHARGING, context);
    }
    ...
    public void ForceFastChargeenable(boolean enable, Context context) {
        run(Control.write(enable ? "0" : "1", FORCE_FAST_CHARGE), FORCE_FAST_CHARGE, context);
    }
